...
def get_metrics(imu1,imu2,imu3,imu4, counter):
    ...
    if(len(Limu1) > 0):
        returnedJson = getMetricsSittingOld01(Limu1, False) 
        return returnedJson

def getMetricsSittingOld01(Limu1, plotdiagrams):
    ...
    for start, end in filtered_pairs:
        ...
        print('movement_durations = ', movement_durations)
    ...
    degrees_of_each_movement = [(2 * mrange) + 6 for mrange in filtered_ranges]

    metrics_data = {
        "total_metrics": {
            "number_of_movements": int(len(filtered_pairs)),
            "pace_movements_per_second": float(pace*10),
...
df_Limu1 = pd.read_csv('/home/vtsakan/Telerehab_DSS/Telerehab_UOI/WP3/imu_mqtt/SittingMetrics/head_FEAC84C53DE7_2024-02-08_14_25_45_TEST.csv')

# Convert the DataFrame to a list of lists
Limu1 = df_Limu1.values.tolist()

# Print the list to verify
print(Limu1)


getMetricsSittingOld01(Limu1, True)