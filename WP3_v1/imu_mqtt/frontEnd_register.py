...
def login(username, password):
    ...
    if response.status_code == 200:
        ...
        with open('/home/vtsakan/Telerehab_DSS/config.ini', 'w') as configfile:
...
def create_gui():
    ...
    logo = Image.open("/home/vtsakan/Telerehab_DSS/logo.png")  # Replace with the correct path to your logo
