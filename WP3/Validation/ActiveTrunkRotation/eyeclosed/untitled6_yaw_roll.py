...
imu_data_trial1 = pd.read_csv(r'/home/uoi/Documents/GitHub/Telerehab_UOI/WP3/Validation/ActiveTrunkRotation/eyeclosed/1Normal_oldSitting3_eye closed-5 rep/Back_2024-03-02T00.24.11.987_E15561CB9161_Quaternion.csv')
imu_data_trial2 = pd.read_csv(r'/home/uoi/Documents/GitHub/Telerehab_UOI/WP3/Validation/ActiveTrunkRotation/eyeclosed/2Normal_oldSitting3_eye closed-5 rep/Back_2024-03-02T00.22.21.203_E15561CB9161_Quaternion.csv')
imu_data_trial3 = pd.read_csv(r'/home/uoi/Documents/GitHub/Telerehab_UOI/WP3/Validation/ActiveTrunkRotation/eyeclosed/3Normal_oldSitting3_eye closed-10 rep/Back_2024-03-02T00.25.55.820_E15561CB9161_Quaternion.csv')
...
roll_data = np.array([roll_trial1, roll_trial2, roll_trial3])
...
# Create combined figure for Mean and Standard Deviation with 2x3 subplots
fig1, axes1 = plt.subplots(2, 4, figsize=(20, 20))
...
axes1[0, 1].plot(roll_trial3, label='Trial 3 Roll', alpha=0.6)
...
axes1[0, 1].axhline(mean_roll_trial3, color='green', linestyle='--', label='Mean Roll Trial 3')
...
axes1[0, 1].fill_between(range(min_length), mean_roll_trial3-std_roll_trial3, mean_roll_trial3+std_roll_trial3, color='green', alpha=0.2)
axes1[0, 1].set_title('Roll Data with Mean \nand Standard Deviation')
...
bland_altman_plot(yaw_trial1, yaw_trial2, axes1[0, 2], 'Bland-Altman Plot for \nYaw Trial 1 and 2')
bland_altman_plot(yaw_trial1, yaw_trial3, axes1[0, 3], 'Bland-Altman Plot for \nYaw Trial 1 and 3')
bland_altman_plot(yaw_trial2, yaw_trial3, axes1[1, 0], 'Bland-Altman Plot for \nYaw Trial 2 and 3')

bland_altman_plot(roll_trial1, roll_trial2, axes1[1, 1], 'Bland-Altman Plot for \nRoll Trial 1 and 2')
bland_altman_plot(roll_trial1, roll_trial3, axes1[1, 2], 'Bland-Altman Plot for \nRoll Trial 1 and 3')
bland_altman_plot(roll_trial2, roll_trial3, axes1[1, 3], 'Bland-Altman Plot for \nRoll Trial 2 and 3')
...
corr_yaw_12, rmse_yaw_12 = plot_correlation_and_rmse(yaw_trial1, yaw_trial2, axes2[0, 0], 'Trial 1 Yaw', 'Trial 2 Yaw')
corr_yaw_13, rmse_yaw_13 = plot_correlation_and_rmse(yaw_trial1, yaw_trial3, axes2[0, 1], 'Trial 1 Yaw', 'Trial 3 Yaw')
corr_yaw_23, rmse_yaw_23 = plot_correlation_and_rmse(yaw_trial2, yaw_trial3, axes2[0, 2], 'Trial 2 Yaw', 'Trial 3 Yaw')

# Correlation and RMSE Plots for Roll
corr_roll_12, rmse_roll_12 = plot_correlation_and_rmse(roll_trial1, roll_trial2, axes2[1, 0], 'Trial 1 Roll', 'Trial 2 Roll')
corr_roll_13, rmse_roll_13 = plot_correlation_and_rmse(roll_trial1, roll_trial3, axes2[1, 1], 'Trial 1 Roll', 'Trial 3 Roll')
corr_roll_23, rmse_roll_23 = plot_correlation_and_rmse(roll_trial2, roll_trial3, axes2[1, 2], 'Trial 2 Roll', 'Trial 3 Roll')
...
print(f'Trial 1 vs Trial 2 (Yaw) - Correlation: {corr_yaw_12:.2f}, RMSE: {rmse_yaw_12:.2f}')
print(f'Trial 1 vs Trial 3 (Yaw) - Correlation: {corr_yaw_13:.2f}, RMSE: {rmse_yaw_13:.2f}')
print(f'Trial 2 vs Trial 3 (Yaw) - Correlation: {corr_yaw_23:.2f}, RMSE: {rmse_yaw_23:.2f}')

print(f'Trial 1 vs Trial 2 (Roll) - Correlation: {corr_roll_12:.2f}, RMSE: {rmse_roll_12:.2f}')
print(f'Trial 1 vs Trial 3 (Roll) - Correlation: {corr_roll_13:.2f}, RMSE: {rmse_roll_13:.2f}')
print(f'Trial 2 vs Trial 3 (Roll) - Correlation: {corr_roll_23:.2f}, RMSE: {rmse_roll_23:.2f}')
