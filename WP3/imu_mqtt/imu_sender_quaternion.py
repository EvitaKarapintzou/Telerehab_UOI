...
def publish(client):
    msg_count = 1
    imu1 = open('head_E25AD03D0194_2024-03-29_14:56:45.csv', newline='')
    imu1Reader = csv.reader(imu1, delimiter=' ', quotechar='|')
    imu2 = open('right_FEAC84C53DE7_2024-04-17_17:27:56.csv', newline='')
    imu2Reader = csv.reader(imu2, delimiter=' ', quotechar='|')
    imu3 = open('right_FEAC84C53DE7_2024-04-17_17:27:56.csv', newline='')
    imu3Reader = csv.reader(imu3, delimiter=' ', quotechar='|')
    imu4 = open('right_FEAC84C53DE7_2024-04-17_17:27:56.csv', newline='')
    ...
    for row in imu2Reader:
        imu2Data.append(format_message("MetaWearE7", "FEAC84C53DE7", ', '.join(row)))

    for row in imu3Reader:
        imu3Data.append(format_message("MetaWearBD", "C8925E7DC6BD", ', '.join(row)))

    for row in imu4Reader:
        imu4Data.append(format_message("MetaWear61", "E15561CB9161", ', '.join(row)))
    sendData = []
