...
def get_metrics(imu1,imu2,imu3,imu4, counter):
    ...
    if(len(Limu1) > 0):
        returnedJson = getMetricsStretchingNew01(Limu1, False) 
        return returnedJson

def getMetricsStretchingNew01(Limu1, plotdiagrams):
    ...
    filename = f"{datetime_string}_HipExternal_metrics.txt"
...
def save_metrics_to_txt(metrics, file_path):
    ...
    sub_directory = "HipExternal Metrics Data"
