...
def get_metrics(imu1,imu2,imu3,imu4, counter):
    ...
    if len(Limu1) > 0 and len(Limu2) > 0 and len(Limu3) > 0:
        returnedJson = getMetricsStandingNew01(Limu1, Limu2, Limu3, False) 
        return returnedJson

def getMetricsStandingNew01(Limu1, Limu2, Limu3, plotdiagrams):
...
#IMU1 RIGHT
    ...
    filename = f"{datetime_string}_LateralWeightsShifts_metrics.txt"
...
def save_metrics_to_txt(metrics, file_path):
    ...
    sub_directory = "LateralWeightsShifts Metrics Data"
