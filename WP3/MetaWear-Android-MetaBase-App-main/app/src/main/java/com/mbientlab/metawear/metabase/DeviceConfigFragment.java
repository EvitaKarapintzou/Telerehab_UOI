...
public class DeviceConfigFragment extends AppFragmentBase {
    ...
    public static View configureButton;
...
//        }, 11000);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Switch dataCollectionToggle = view.findViewById(R.id.data_collection_toggle);

        dataCollectionToggle.setChecked(true);
...
//        View configureButton = view.findViewById(R.id.configure);
//        configureButton.performClick();

//        configureButton = view.findViewById(R.id.configure);
//        configureButton.performClick();
                    ...
                    Task.callInBackground(() -> {
                        ...
                        task.continueWith(task2 -> {
                            ...
                            if (task2.isFaulted()) {
                                ...
                                AlertDialog alertDialog = new AlertDialog.Builder(owner)
                                        .setTitle(R.string.title_error)
                                        .setMessage(errorMsg)
