...
public class MyJobIntentService extends JobIntentService {
    ...
    protected void onHandleWork(Intent intent) {
        // Retrieve the context identifier from the intent
        int contextIdentifier = intent.getIntExtra("contextIdentifier", -1);

        // Find the correct HomeActivity instance based on the identifier
        HomeActivity homeActivity = findHomeActivityByHashCode(contextIdentifier);

        if (homeActivity != null) {
            System.out.println("TTTTTTTTTTTT");
            // Now you can use homeActivity as the correct context for bindService
            ...
            System.out.println("TTTTTTTTTTTT22222");
            ...
            System.out.println("TTTTTTTTTTTT33333");
        }
    ...
    private HomeActivity findHomeActivityByHashCode(int hashCode) {
        // Get the active instance directly
    ...
    private void performBackgroundTasks() {
        ...
        System.out.println("EXWWWWWWWWWWW");


        // Add your Bluetooth operations or other background tasks here
        // For example, initiate Bluetooth scanning
        // Note: Be sure to manage Bluetooth operations properly, considering permissions, scanning lifecycle, etc.
    }
