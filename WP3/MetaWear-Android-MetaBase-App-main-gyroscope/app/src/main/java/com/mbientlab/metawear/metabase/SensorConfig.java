...
abstract class SensorConfig {
    ...
    private static Integer numOfSensors = 0;
    ...
    static class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            System.out.println("Sto Sensor Config prin to sensor++");
            if (ranges.length > 0) {
            ...
            numOfSensors++;
            System.out.println("EXWWWWWWW " + numOfSensors);

            if(numOfSensors % 7 == 0 && numOfSensors != 7){
                //System.exit(1);
                ...
                builder.setTitle("Alert")
                        ...
                        .setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                // User clicked Continue, print "OK"
                                numOfSensors = 7;
                                DeviceConfigFragment dev= new DeviceConfigFragment();
                                dev.startConfigure();
                                System.out.println("OK");
                                // Add your further logic here if needed
                            }
                        })
                        .setNegativeButton("Exit", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                // User clicked Exit, terminate the program
                                System.exit(0); // Note: This method is generally not recommended
                            }
                        })
                        .setCancelable(false)
                        .show();
...
//                    @Override
//                    public void run() {
//                        // Automatically select the "Exit" button
//                        ((AlertDialog) builder.create()).getButton(DialogInterface.BUTTON_POSITIVE).performClick();
//                    }
//                }, 100);
            }
            ...
            if(current.identifier.equals("linear-acceleration")){
                System.out.println("QUAAAAAAAAAAAAAAAAATEEEEEEEEEEEERNIONNNNNNNNN");
            ...
            enable.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                System.out.println("MPHKA STO ENABLE!!!");
                if (current.isEnabled) {
                    ...
                    if (throughputOk) {
                        ...
                        System.out.println("PRIN TO CONFIGURE");
                        // DeviceConfigFragment DEV = new DeviceConfigFragment();   //!!!!!!!!!!!
                        //DEV.startConfigure();
                    } else {
                        new AlertDialog.Builder(holder.itemView.getContext())
